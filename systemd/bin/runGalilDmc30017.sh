...
export DMC30017_CURRENT_BISS_POLL=DMC30017_${DMC30017_INSTANCE}_BISS_POLL
export DMC30017_CURRENT_BISS_CLKDIV=DMC30017_${DMC30017_INSTANCE}_BISS_CLKDIV
export DMC30017_CURRENT_BISS_DATANUM1=DMC30017_${DMC30017_INSTANCE}_BISS_DATANUM1
export DMC30017_CURRENT_BISS_DATANUM2=DMC30017_${DMC30017_INSTANCE}_BISS_DATANUM2
export DMC30017_CURRENT_BISS_ZEROPAD=DMC30017_${DMC30017_INSTANCE}_BISS_ZEROPAD
export DMC30017_CURRENT_BISS_INPUT=DMC30017_${DMC30017_INSTANCE}_BISS_INPUT
export DMC30017_CURRENT_BISS_LEVEL=DMC30017_${DMC30017_INSTANCE}_BISS_LEVEL
...
export DMC30017_BISS_POLL=${!DMC30017_CURRENT_BISS_POLL}
export DMC30017_BISS_CLKDIV=${!DMC30017_CURRENT_BISS_CLKDIV}
export DMC30017_BISS_DATANUM1=${!DMC30017_CURRENT_BISS_DATANUM1}
export DMC30017_BISS_DATANUM2=${!DMC30017_CURRENT_BISS_DATANUM2}
export DMC30017_BISS_ZEROPAD=${!DMC30017_CURRENT_BISS_ZEROPAD}
export DMC30017_BISS_INPUT=${!DMC30017_CURRENT_BISS_INPUT}
export DMC30017_BISS_LEVEL=${!DMC30017_CURRENT_BISS_LEVEL}
...
/usr/bin/docker run \
    ...
    -O "${DMC30017_BISS_POLL}" \
    -C "${DMC30017_BISS_CLKDIV}" \
    -A "${DMC30017_BISS_DATANUM1}" \
    -B "${DMC30017_BISS_DATANUM2}" \
